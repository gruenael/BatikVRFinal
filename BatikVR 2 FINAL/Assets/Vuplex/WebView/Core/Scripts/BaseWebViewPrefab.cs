...
namespace Vuplex.WebView {
    ...
    public abstract class BaseWebViewPrefab : MonoBehaviour {
        ...
        /// <summary>
        /// Determines whether the webview automatically receives keyboard input from the native keyboard and the Keyboard prefab.
        /// </summary>
    ...
    #region Non-public members
        ...
        protected virtual void OnDestroy() {
            ...
            if (KeyboardEnabled) {
                Internal.KeyboardManager.Instance?.SetKeyboardEnabled(this, false);
            }
            Destroy();
